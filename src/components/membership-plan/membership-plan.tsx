...
import { MembershipProps } from "./membership-plan-props";
import moment from 'moment';


const MembershipPlan = ({ subscription }:MembershipProps) => {
        ...
        <div className='mt-6 grid grid-cols-1 gap-x-4 border px-4 py-4 md:grid-cols-4 md:bordder-x-0 md:border-t md:border-b-0 md:pb-0'>
            ...
            <div className='col-span-3'>
                <div className='flex flex-col justify-between border-b border-white/10 py-4 md:flex-row'>
                    <div>
                        <p onClick={openPortal} className='font-medium'>{subscription.customer.email}</p>
                        <p onClick={openPortal} className='text-[gray]'>Password: ******</p>
                    </div>
