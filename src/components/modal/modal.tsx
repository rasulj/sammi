...
//   const [loding, isLoding] = useState<boolean>(false);
//   const {user}  = useContext(AuthContext)
//  const router = useRouter()
...
//           />
//           <div className='absolute bottom-10 flex w-full pl-10 items-center justify-between px-18'>
//             <div className='flex space-x-2'>
...
//               </button>
//               <button onClick={adProductList} className='modalButton'>
//                 {loding ? "... ": <BiPlus  className='w-7 h-7' /> }
